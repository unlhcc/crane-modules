help (
[[
This module makes available InterProScan 5.24 (Protein Functional Analysis).
...
prepend_path("PATH"       ,"/util/opt/BCRF/interproscan/5.24")

pushenv("TEST_PROT"	, "/util/opt/BCRF/interproscan/5.24/test_proteins.fasta")
prereq("java/1.8")
