...
setenv("BOOST_DIR",	          "/util/opt/boost/1.44/gcc/4.9")
setenv("Boost_DIR",	          "/util/opt/boost/1.44/gcc/4.9")
setenv("BOOST_INCLUDE",           "/util/opt/boost/1.44/gcc/4.9/include")
setenv("BOOST_ROOT",              "/util/opt/boost/1.44/gcc/4.9")
setenv("BOOST_LIBRARYDIR",        "/util/opt/boost/1.44/gcc/4.9/lib")
setenv("BOOST_INCLUDEDIR",        "/util/opt/boost/1.44/gcc/4.9/include")

-- Add boost to the LD_LIBRARY_PATH, LIBRARY_PATH
prepend_path("LD_LIBRARY_PATH",   "/util/opt/boost/1.44/gcc/4.9/lib")
prepend_path("LIBRARY_PATH",      "/util/opt/boost/1.44/gcc/4.9/lib")

prepend_path("CPATH",             "/util/opt/boost/1.44/gcc/4.9/include")
