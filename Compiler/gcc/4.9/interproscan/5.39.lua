...
prepend_path("PATH"       ,"/util/opt/BCRF/interproscan/5.39/gcc/4.9")

pushenv("TEST_PROT"	, "/util/opt/BCRF/interproscan/5.39/gcc/4.9/test_proteins.fasta")

always_load("java/11", "python/3.7")
