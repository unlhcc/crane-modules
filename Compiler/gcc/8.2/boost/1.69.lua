...
prepend_path("LD_LIBRARY_PATH",   "/util/opt/boost/1.69/gcc/8.2/lib")
prepend_path("LIBRARY_PATH",      "/util/opt/boost/1.69/gcc/8.2/lib")
prepend_path("CPATH",      "/util/opt/boost/1.69/gcc/8.2/include")
