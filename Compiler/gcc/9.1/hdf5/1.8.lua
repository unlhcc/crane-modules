...
prepend_path("PATH",                "/util/opt/hdf5/1.8/gcc/9.1/bin")
prepend_path("LD_LIBRARY_PATH",     "/util/opt/hdf5/1.8/gcc/9.1/lib")
prepend_path("MANPATH",             "/util/opt/hdf5/1.8/gcc/9.1/share/hdf5_examples")
prepend_path("INCLUDE",             "/util/opt/hdf5/1.8/gcc/9.1/include")
