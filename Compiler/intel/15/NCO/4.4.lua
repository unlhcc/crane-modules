...
prepend_path("PATH",		    "/util/opt/NCO/4.4/intel/15/bin")
prepend_path("LD_LIBRARY_PATH",     "/util/opt/NCO/4.4/intel/15/lib")
prepend_path("MANPATH",             "/util/opt/NCO/4.4/intel/15/share/man")
prepend_path("INCLUDE",             "/util/opt/NCO/4.4/intel/15/include")

family("NCO")

prepend_path("CPATH",             "/util/opt/NCO/4.4/intel/15/include")
prepend_path("LIBRARY_PATH",     "/util/opt/NCO/4.4/intel/15/lib")