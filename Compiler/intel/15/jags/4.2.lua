...
prepend_path("PATH",              "/util/opt/jags/4.2/intel/15/bin")
prepend_path("LD_LIBRARY_PATH",   "/util/opt/jags/4.2/intel/15/lib")
prepend_path("MANPATH",   "/util/opt/jags/4.2/intel/15/share/man")

prereq("intel-mkl/15")

prepend_path("LIBRARY_PATH",   "/util/opt/jags/4.2/intel/15/lib")
prepend_path("PKG_CONFIG_PATH",        "/util/opt/jags/4.2/intel/15/lib/pkgconfig")