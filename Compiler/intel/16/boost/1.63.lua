...
setenv("BOOST_DIR",         "/util/opt/boost/1.63/intel/16")
setenv("BOOST_INCLUDE",     "/util/opt/boost/1.63/intel/16/include")

-- Add boost to the LD_LIBRARY_PATH, LIBRARY_PATH
prepend_path("LD_LIBRARY_PATH",   "/util/opt/boost/1.63/intel/16/lib")
prepend_path("LIBRARY_PATH",      "/util/opt/boost/1.63/intel/16/lib")
prepend_path("CPATH",      "/util/opt/boost/1.63/intel/16/include")
