...
prepend_path("CPATH",             "/util/opt/netcdf/4.2/pgi/15/include")
prepend_path("LIBRARY_PATH",     "/util/opt/netcdf/4.2/pgi/15/lib")
prepend_path("PKG_CONFIG_PATH",        "/util/opt/netcdf/4.2/pgi/15/lib/pkgconfig")