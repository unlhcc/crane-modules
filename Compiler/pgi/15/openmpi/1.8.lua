...
prepend_path("PATH",                "/util/opt/openmpi/1.8.4/pgi/15/bin")
prepend_path("LD_LIBRARY_PATH",     "/util/opt/openmpi/1.8.4/pgi/15/lib")
prepend_path("MANPATH",             "/util/opt/openmpi/1.8.4/pgi/15/share/man")
prepend_path("INCLUDE",             "/util/opt/openmpi/1.8.4/pgi/15/include")
