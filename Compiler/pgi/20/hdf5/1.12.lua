...
prepend_path("PATH",                "/util/opt/hdf5/1.12/pgi/20/bin")
prepend_path("LD_LIBRARY_PATH",     "/util/opt/hdf5/1.12/pgi/20/lib")
prepend_path("MANPATH",             "/util/opt/hdf5/1.12/pgi/20/share/man")
prepend_path("INCLUDE",             "/util/opt/hdf5/1.12/pgi/20/include")
