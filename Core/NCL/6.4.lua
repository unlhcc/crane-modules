...
prepend_path("PATH","/util/opt/NCL/6.4/bin")
prepend_path("MANPATH","/util/opt/NCL/6.4/man")

setenv("NCARG_ROOT","/util/opt/NCL/6.4")
setenv("NCARG_INC","/util/opt/NCL/6.4/include")
setenv("NCARG_LIB","/util/opt/NCL/6.4/lib")
setenv("NCARG_BIN","/util/opt/NCL/6.4/bin")
