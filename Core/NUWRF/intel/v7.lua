...
prepend_path("LIBRARY_PATH",     "/util/opt/hdf5/1.8.7/intel/13/lib")
prepend_path("CPATH",             "/util/opt/hdf5/1.8.7/intel/13/include")
setenv("HDF5",		"/util/opt/hdf5/1.8.7/intel/13")
setenv("HDF5_PATH",     "/util/opt/hdf5/1.8.7/intel/13")
setenv("HDF5_INCLUDE",  "/util/opt/hdf5/1.8.7/intel/13/include")
...
prepend_path("CPATH",           "/util/opt/jasper/1.900.1/intel/13/include")
setenv("JASPERLIB",	        "/util/opt/jasper/1.900.1/intel/13/lib")
prepend_path("LIBRARY_PATH",     "/util/opt/jasper/1.900.1/intel/13/lib")
setenv("BUFRLIB",	"/util/opt/bufrlib/10.2.3/intel/13")
prepend_path("BUFRLIB",       "/util/opt/bufrlib/10.2.3/intel/13")
