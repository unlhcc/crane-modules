...
prepend_path("PATH",              "/util/opt/cuda/8.0/bin")
prepend_path("LD_LIBRARY_PATH",   "/util/opt/cuda/8.0/lib64")
prepend_path("LD_LIBRARY_PATH",   "/util/opt/cuda/8.0/lib")
prepend_path("LD_LIBRARY_PATH",   "/usr/lib64/nvidia")
prepend_path("LIBRARY_PATH",      "/util/opt/cuda/8.0/lib64")
prepend_path("LIBRARY_PATH",      "/util/opt/cuda/8.0/lib")
prepend_path("LIBRARY_PATH",      "/usr/lib64/nvidia")
prepend_path("MANPATH",		  "/util/opt/cuda/8.0/doc/man")
prepend_path("CPATH",		  "/util/opt/cuda/8.0/include")
setenv("CUDA_HOME",		  "/util/opt/cuda/8.0")
