...
pushenv("GATK"          , "/util/opt/BCRF/gatk/3.7/GenomeAnalysisTK.jar")
pushenv("GATK_RUN"      , "java -Xms512m -Xmx2g -jar /util/opt/BCRF/gatk/3.7/GenomeAnalysisTK.jar ")
pushenv("GATK_RESOURCES", "/util/opt/BCRF/gatk/3.7/resources")
