...
Version 3.10.2ae87b9
]]
)
whatis("Name: Mumax3")
whatis("Version: 3.10.2ae87b9")
...
pushenv("CONDA_DEFAULT_ENV", "mumax3-3.10.2ae87b9")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/mumax3/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/mumax3/envs/mumax3-3.10.2ae87b9/bin")
