...
pushenv("CONDA_DEFAULT_ENV", "mumax3-3.9.3")
append_path("CONDA_ENVS_PATH", "/util/opt/anaconda/deployed-conda-envs/packages/mumax3/envs")
prepend_path("PATH", "/util/opt/anaconda/deployed-conda-envs/packages/mumax3/envs/mumax3-3.9.3/bin")
