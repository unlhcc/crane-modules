...
prepend_path("PATH",			"/util/opt/anaconda/4.3/envs/orthofinder-1.1.8/bin")
prepend_path("LD_LIBRARY_PATH",		"/util/opt/anaconda/4.3/envs/orthofinder-1.1.8/lib")
prepend_path("INCLUDE",			"/util/opt/anaconda/4.3/envs/orthofinder-1.1.8/include")
prepend_path("MANPATH",			"/util/opt/anaconda/4.3/envs/orthofinder-1.1.8/share/man")
