...
setenv("QIIME_CONFIG_FP", "/util/opt/anaconda/2.0/envs/qiime-1.9.1/qiime_config")
...
prepend_path("PATH",            "/util/opt/anaconda/2.0/envs/qiime-1.9.1/bin/ChimeraSlayer")

setenv("RDP_JAR_PATH",		"/util/opt/anaconda/2.0/envs/qiime-1.9.1/bin/rdp_classifier-2.2.jar")
setenv("BLASTMAT", 		"/util/opt/anaconda/2.0/envs/qiime-1.9.1/data")
...
setenv("SOURCETRACKER_PATH","/util/opt/anaconda/2.0/envs/qiime-1.9.1/lib")

load("compiler/gcc/4.9","openmpi/1.8")

pushenv("CONDA_DEFAULT_ENV","qiime-1.9.1")
prepend_path{"PATH","/util/opt/anaconda/2.0/envs/qiime-1.9.1/bin",priority=100}
