...
prepend_path{"PATH",                "/util/opt/ESMF/5.2/openmpi/1.6/intel/13/bin",priority=100}
prepend_path("LD_LIBRARY_PATH",     "/util/opt/ESMF/5.2/openmpi/1.6/intel/13/lib")
prepend_path("MANPATH",             "/util/opt/ESMF/5.2/openmpi/1.6/intel/13/doc")
