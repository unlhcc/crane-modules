...
-- -- See RT #7945.
load("compiler/intel/15","openmpi/1.10","NCL/6.3","NCO/4.4","udunits2/2.2","szip/2.1","hdf5/1.8","hdf4/4.2","netcdf/4.4")
setenv("WRFIO_NCD_LARGE_FILE_SUPPORT", "1")
setenv("JASPERINC", "/util/opt/jasper/1.900.1/intel/15/include")
setenv("JASPERLIB", "/util/opt/jasper/1.900.1/intel/15/lib")
...
prepend_path("PATH",                "/util/opt/wgrib/1.8/intel/15/bin")

--Cindy asked for this software RT# 6830
prepend_path("PATH",                "/util/opt/ncview/2.1/intel/15/bin")
